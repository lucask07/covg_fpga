...
module observer_fixpt_folded_tb;
  ...
  reg signed [31:0] rawData_B_1;  // sfix32_En31
  reg signed [31:0] status_B_1;  // sfix32
  reg signed [31:0] holdData_B_1;  // sfix32_En31
  reg signed [31:0] B_1_offset;  // sfix32_En31
  wire signed [31:0] B_1;  // sfix32_En31
  reg [6:0] y1_addr;  // ufix7
  reg signed [31:0] fp_B_0;  // sfix32
  reg signed [31:0] rawData_B_0;  // sfix32_En31
  reg signed [31:0] status_B_0;  // sfix32
  reg signed [31:0] holdData_B_0;  // sfix32_En31
  reg signed [31:0] B_0_offset;  // sfix32_En31
  wire signed [31:0] B_0;  // sfix32_En31
  wire [6:0] A_addr_delay;  // ufix7
  reg signed [31:0] fp_A_3;  // sfix32
  reg signed [31:0] rawData_A_3;  // sfix32_En31
  reg signed [31:0] status_A_3;  // sfix32
  reg signed [31:0] holdData_A_3;  // sfix32_En31
  reg signed [31:0] A_3_offset;  // sfix32_En31
  wire signed [31:0] A_3;  // sfix32_En31
  reg signed [31:0] fp_A_2;  // sfix32
  reg signed [31:0] rawData_A_2;  // sfix32_En31
  reg signed [31:0] status_A_2;  // sfix32
  reg signed [31:0] holdData_A_2;  // sfix32_En31
  reg signed [31:0] A_2_offset;  // sfix32_En31
  wire signed [31:0] A_2;  // sfix32_En31
  reg signed [31:0] fp_A_1;  // sfix32
  reg signed [31:0] rawData_A_1;  // sfix32_En31
  reg signed [31:0] status_A_1;  // sfix32
  reg signed [31:0] holdData_A_1;  // sfix32_En31
  reg signed [31:0] A_1_offset;  // sfix32_En31
  wire signed [31:0] A_1;  // sfix32_En31
  reg signed [31:0] fp_A_0;  // sfix32
  reg signed [31:0] rawData_A_0;  // sfix32_En31
  reg signed [31:0] status_A_0;  // sfix32
  reg signed [31:0] holdData_A_0;  // sfix32_En31
  reg signed [31:0] A_0_offset;  // sfix32_En31
  wire signed [31:0] A_0;  // sfix32_En31
  wire [6:0] L_addr_delay;  // ufix7
  reg signed [31:0] fp_L_3;  // sfix32
  reg signed [31:0] rawData_L_3;  // sfix32_En31
  reg signed [31:0] status_L_3;  // sfix32
  reg signed [31:0] holdData_L_3;  // sfix32_En31
  reg signed [31:0] L_3_offset;  // sfix32_En31
  wire signed [31:0] L_3;  // sfix32_En31
  reg signed [31:0] fp_L_2;  // sfix32
  reg signed [31:0] rawData_L_2;  // sfix32_En31
  reg signed [31:0] status_L_2;  // sfix32
  reg signed [31:0] holdData_L_2;  // sfix32_En31
  reg signed [31:0] L_2_offset;  // sfix32_En31
  wire signed [31:0] L_2;  // sfix32_En31
  reg signed [31:0] fp_L_1;  // sfix32
  reg signed [31:0] rawData_L_1;  // sfix32_En31
  reg signed [31:0] status_L_1;  // sfix32
  reg signed [31:0] holdData_L_1;  // sfix32_En31
  reg signed [31:0] L_1_offset;  // sfix32_En31
  wire signed [31:0] L_1;  // sfix32_En31
  reg signed [31:0] fp_L_0;  // sfix32
  reg signed [31:0] rawData_L_0;  // sfix32_En31
  reg signed [31:0] status_L_0;  // sfix32
  reg signed [31:0] holdData_L_0;  // sfix32_En31
  reg signed [31:0] L_0_offset;  // sfix32_En31
  wire signed [31:0] L_0;  // sfix32_En31
