...
module observer_fixpt_tb;
  ...
  wire constone;  // ufix1
  reg  out_0_chkenb;  // ufix1
  wire out_0_chkdata;  // ufix1
  ...
  always @(posedge clk or posedge reset)
    begin : out_0_IgnoreDataChecking
      if (reset) begin
        out_0_chkenb <= 0;
      end
      else begin
        if (ce_out) begin
          out_0_chkenb <= constone;
        end
      end
    end

  assign out_0_chkdata = ce_out & out_0_chkenb;
  ...
  always @(posedge clk or posedge reset)
    begin : out_0_checker
      if (reset == 1'b1) begin
        ...
        if (out_0_chkdata == 1'b1 && out_0 !== out_0_ref) begin
  ...
  always @(posedge clk or posedge reset)
    begin : out_1_checker
      if (reset == 1'b1) begin
        ...
        if (out_0_chkdata == 1'b1 && out_1 !== out_1_ref) begin
