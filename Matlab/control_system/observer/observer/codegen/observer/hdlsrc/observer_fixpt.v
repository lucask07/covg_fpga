...
module observer_fixpt
  ...
  input   reset;
  input   clk_enable;
  input   signed [15:0] y1;  // sfix16
  input   signed [15:0] y2;  // sfix16
  input   signed [15:0] u;  // sfix16
  ...
  input   [31:0] B_0;  // ufix32_En50
  input   [31:0] B_1;  // ufix32_En50
  output  ce_out;
  output  signed [15:0] out_0;  // sfix16_En15
  output  signed [15:0] out_1;  // sfix16_En15


  wire enb;
  wire enb_1_1_1;
  wire enb_40_1_0;
  wire signed [31:0] A [0:3];  // sfix32_En24 [4]
  wire signed [31:0] Am [0:3];  // sfix32_En24 [4]
  wire signed [65:0] c [0:1];  // sfix66_En56 [2]
  wire clk_enable_1;
  wire [31:0] B [0:1];  // ufix32_En50 [2]
  wire [31:0] Bm [0:1];  // ufix32_En50 [2]
  wire signed [31:0] L [0:3];  // sfix32_En50 [4]
  wire signed [31:0] Lm [0:3];  // sfix32_En50 [4]
  wire signed [15:0] y [0:1];  // sfix16 [2]
  wire signed [48:0] c_1 [0:1];  // sfix49_En50 [2]
  reg signed [48:0] c_2 [0:1];  // sfix49_En50 [2]
  wire signed [48:0] c_3 [0:1];  // sfix49_En50 [2]
  wire signed [32:0] tmp [0:1];  // sfix33_En32 [2]
  wire signed [32:0] yest [0:1];  // sfix33_En32 [2]
  reg signed [32:0] yest_reg_reg [0:1];  // sfix33 [2]
  wire signed [32:0] yest_reg_reg_next [0:1];  // sfix33_En32 [2]
  wire signed [32:0] yest_1 [0:1];  // sfix33_En32 [2]
  reg signed [65:0] c_4 [0:1];  // sfix66_En56 [2]
  wire signed [65:0] c_5 [0:1];  // sfix66_En56 [2]
  wire signed [66:0] p11tmp_add_cast [0:1];  // sfix67_En56 [2]
  wire signed [32:0] p11tmp_cast [0:1];  // sfix33_En50 [2]
  wire signed [48:0] p11tmp_mul_temp [0:1];  // sfix49_En50 [2]
  wire signed [47:0] p11tmp_add_cast_1 [0:1];  // sfix48_En50 [2]
  wire signed [66:0] p11tmp_add_cast_2 [0:1];  // sfix67_En56 [2]
  wire signed [66:0] p11tmp_add_temp [0:1];  // sfix67_En56 [2]
  wire signed [67:0] p11tmp_add_cast_3 [0:1];  // sfix68_En56 [2]
  wire signed [67:0] p11tmp_add_cast_4 [0:1];  // sfix68_En56 [2]
  wire signed [67:0] p11tmp_add_temp_1 [0:1];  // sfix68_En56 [2]
  wire signed [15:0] out [0:1];  // sfix16_En15 [2]
  reg signed [15:0] out_reg_reg [0:1];  // sfix16 [2]
  wire signed [15:0] out_reg_reg_next [0:1];  // sfix16_En15 [2]
  wire signed [15:0] out_2 [0:1];  // sfix16_En15 [2]
  reg signed [31:0] p1_k;  // int32
  reg signed [31:0] p1_l;  // int32
  reg signed [48:0] p1_slice_temp;  // sfix49_En50
  reg signed [49:0] p1_add_cast [0:1];  // sfix50_En50 [2]
  reg signed [63:0] p1_add_cast_0 [0:1];  // sfix64 [2]
  reg signed [47:0] p1_mul_temp [0:1];  // sfix48_En50 [2]
  reg signed [49:0] p1_add_cast_1 [0:1];  // sfix50_En50 [2]
  reg signed [49:0] p1_add_temp [0:1];  // sfix50_En50 [2]
  reg signed [31:0] p5_k;  // int32
  reg signed [31:0] p5_l;  // int32
  reg signed [65:0] p5_slice_temp;  // sfix66_En56
  reg signed [66:0] p5_add_cast [0:1];  // sfix67_En56 [2]
  reg signed [63:0] p5_add_cast_0 [0:1];  // sfix64 [2]
  reg signed [64:0] p5_mul_temp [0:1];  // sfix65_En56 [2]
  reg signed [66:0] p5_add_cast_1 [0:1];  // sfix67_En56 [2]
  reg signed [66:0] p5_add_temp [0:1];  // sfix67_En56 [2]
  ...
  assign p11tmp_cast[0] = {1'b0, Bm[0]};
  assign p11tmp_mul_temp[0] = p11tmp_cast[0] * u;
  assign p11tmp_add_cast_1[0] = p11tmp_mul_temp[0][47:0];
  assign p11tmp_add_cast_2[0] = {{13{p11tmp_add_cast_1[0][47]}}, {p11tmp_add_cast_1[0], 6'b000000}};
  assign p11tmp_add_temp[0] = p11tmp_add_cast[0] + p11tmp_add_cast_2[0];
  assign p11tmp_add_cast_3[0] = {p11tmp_add_temp[0][66], p11tmp_add_temp[0]};
  assign p11tmp_add_cast_4[0] = {{13{c_3[0][48]}}, {c_3[0], 6'b000000}};
  assign p11tmp_add_temp_1[0] = p11tmp_add_cast_3[0] + p11tmp_add_cast_4[0];
  assign tmp[0] = p11tmp_add_temp_1[0][56:24];
  assign p11tmp_add_cast[1] = {c_5[1][65], c_5[1]};
  assign p11tmp_cast[1] = {1'b0, Bm[1]};
  assign p11tmp_mul_temp[1] = p11tmp_cast[1] * u;
  assign p11tmp_add_cast_1[1] = p11tmp_mul_temp[1][47:0];
  assign p11tmp_add_cast_2[1] = {{13{p11tmp_add_cast_1[1][47]}}, {p11tmp_add_cast_1[1], 6'b000000}};
  assign p11tmp_add_temp[1] = p11tmp_add_cast[1] + p11tmp_add_cast_2[1];
  assign p11tmp_add_cast_3[1] = {p11tmp_add_temp[1][66], p11tmp_add_temp[1]};
  assign p11tmp_add_cast_4[1] = {{13{c_3[1][48]}}, {c_3[1], 6'b000000}};
  assign p11tmp_add_temp_1[1] = p11tmp_add_cast_3[1] + p11tmp_add_cast_4[1];
  assign tmp[1] = p11tmp_add_temp_1[1][56:24];
