// -------------------------------------------------------------
// 
// File Name: /Users/koer2434/Documents/covg_fpga/Matlab/control_system/observer/observer/codegen/observer/hdlsrc/observer_fixpt.v
...
module observer_fixpt
  ...
  wire signed [15:0] Am [0:3];  // sfix16_En15 [4]
  wire signed [49:0] c [0:1];  // sfix50_En45 [2]
  wire clk_enable_1;
  wire signed [15:0] B [0:1];  // sfix16_En15 [2]
  wire signed [15:0] Bm [0:1];  // sfix16_En15 [2]
  wire signed [15:0] L [0:3];  // sfix16_En15 [4]
  wire signed [15:0] Lm [0:3];  // sfix16_En15 [4]
  wire signed [13:0] y [0:1];  // sfix14_En13 [2]
  wire signed [30:0] c_1 [0:1];  // sfix31_En28 [2]
  reg signed [30:0] c_2 [0:1];  // sfix31_En28 [2]
  wire signed [30:0] c_3 [0:1];  // sfix31_En28 [2]
  ...
  reg signed [49:0] c_4 [0:1];  // sfix50_En45 [2]
  wire signed [49:0] c_5 [0:1];  // sfix50_En45 [2]
  wire signed [50:0] p11tmp_add_cast [0:1];  // sfix51_En45 [2]
  wire signed [31:0] p11tmp_mul_temp [0:1];  // sfix32_En30 [2]
  wire signed [50:0] p11tmp_add_cast_1 [0:1];  // sfix51_En45 [2]
  wire signed [50:0] p11tmp_add_temp [0:1];  // sfix51_En45 [2]
  wire signed [51:0] p11tmp_add_cast_2 [0:1];  // sfix52_En45 [2]
  wire signed [51:0] p11tmp_add_cast_3 [0:1];  // sfix52_En45 [2]
  wire signed [51:0] p11tmp_add_temp_1 [0:1];  // sfix52_En45 [2]
  wire signed [15:0] out [0:1];  // sfix16_En13 [2]
  reg signed [31:0] p1_k;  // int32
  reg signed [31:0] p1_l;  // int32
  reg signed [30:0] p1_slice_temp;  // sfix31_En28
  reg signed [31:0] p1_add_cast [0:1];  // sfix32_En28 [2]
  reg signed [63:0] p1_add_cast_0 [0:1];  // sfix64 [2]
  reg signed [29:0] p1_mul_temp [0:1];  // sfix30_En28 [2]
  reg signed [31:0] p1_add_cast_1 [0:1];  // sfix32_En28 [2]
  reg signed [31:0] p1_add_temp [0:1];  // sfix32_En28 [2]
  reg signed [31:0] p5_k;  // int32
  reg signed [31:0] p5_l;  // int32
  reg signed [49:0] p5_slice_temp;  // sfix50_En45
  reg signed [50:0] p5_add_cast [0:1];  // sfix51_En45 [2]
  reg signed [63:0] p5_add_cast_0 [0:1];  // sfix64 [2]
  reg signed [48:0] p5_mul_temp [0:1];  // sfix49_En45 [2]
  reg signed [50:0] p5_add_cast_1 [0:1];  // sfix51_En45 [2]
  reg signed [50:0] p5_add_temp [0:1];  // sfix51_En45 [2]
  ...
  assign c[0] = 50'sh0000000000000;
  assign c[1] = 50'sh0000000000000;
  ...
  assign c_1[0] = 31'sb0000000000000000000000000000000;
  assign c_1[1] = 31'sb0000000000000000000000000000000;



  always @* begin
    p1_slice_temp = 31'sb0000000000000000000000000000000;
  ...
  assign p11tmp_add_cast[0] = {c_5[0][49], c_5[0]};
  assign p11tmp_mul_temp[0] = Bm[0] * u;
  assign p11tmp_add_cast_1[0] = {{4{p11tmp_mul_temp[0][31]}}, {p11tmp_mul_temp[0], 15'b000000000000000}};
  assign p11tmp_add_temp[0] = p11tmp_add_cast[0] + p11tmp_add_cast_1[0];
  assign p11tmp_add_cast_2[0] = {p11tmp_add_temp[0][50], p11tmp_add_temp[0]};
  assign p11tmp_add_cast_3[0] = {{4{c_3[0][30]}}, {c_3[0], 17'b00000000000000000}};
  assign p11tmp_add_temp_1[0] = p11tmp_add_cast_2[0] + p11tmp_add_cast_3[0];
  assign tmp[0] = p11tmp_add_temp_1[0][47:15];
  assign p11tmp_add_cast[1] = {c_5[1][49], c_5[1]};
  assign p11tmp_mul_temp[1] = Bm[1] * u;
  assign p11tmp_add_cast_1[1] = {{4{p11tmp_mul_temp[1][31]}}, {p11tmp_mul_temp[1], 15'b000000000000000}};
  assign p11tmp_add_temp[1] = p11tmp_add_cast[1] + p11tmp_add_cast_1[1];
  assign p11tmp_add_cast_2[1] = {p11tmp_add_temp[1][50], p11tmp_add_temp[1]};
  assign p11tmp_add_cast_3[1] = {{4{c_3[1][30]}}, {c_3[1], 17'b00000000000000000}};
  assign p11tmp_add_temp_1[1] = p11tmp_add_cast_2[1] + p11tmp_add_cast_3[1];
  assign tmp[1] = p11tmp_add_temp_1[1][47:15];
