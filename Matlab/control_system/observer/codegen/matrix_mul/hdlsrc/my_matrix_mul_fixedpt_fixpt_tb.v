...
module matrix_mul_fixedpt_fixpt_tb;
  ...
  reg  reset;
  wire enb_1_40_0;
  wire signed [13:0] rawData_A_0;  // sfix14_En3
  wire signed [13:0] rawData_A_1;  // sfix14_En3
  wire signed [13:0] rawData_A_3;  // sfix14_En3
  wire out_0_done;  // ufix1
  wire ce_out;
  wire out_0_done_enb;  // ufix1
  reg [7:0] out_0_addr;  // ufix8
  wire out_0_active;  // ufix1
  wire [7:0] B_addr_delay;  // ufix8
  wire tb_enb;
  wire phase_1;
  reg signed [31:0] fp_B_1;  // sfix32
  reg signed [13:0] rawData_B_1;  // sfix14_E8
  reg signed [31:0] status_B_1;  // sfix32
  reg signed [13:0] holdData_B_1;  // sfix14_E8
  reg signed [13:0] B_1_offset;  // sfix14_E8
  wire signed [13:0] B_1;  // sfix14_E8
  reg [7:0] A_addr;  // ufix8
  reg signed [31:0] fp_B_0;  // sfix32
  reg signed [13:0] rawData_B_0;  // sfix14_E8
  reg signed [31:0] status_B_0;  // sfix32
  reg signed [13:0] holdData_B_0;  // sfix14_E8
  reg signed [13:0] B_0_offset;  // sfix14_E8
  wire signed [13:0] B_0;  // sfix14_E8
  reg signed [13:0] holdData_A_3;  // sfix14_En3
  reg signed [13:0] A_3_offset;  // sfix14_En3
  wire signed [13:0] A_3_1;  // sfix14_En3
  wire A_active;  // ufix1
  wire A_enb;  // ufix1
  wire [7:0] A_addr_delay_1;  // ufix8
  reg signed [31:0] fp_A_2;  // sfix32
  reg signed [13:0] rawData_A_2;  // sfix14_En3
  reg signed [31:0] status_A_2;  // sfix32
  reg signed [13:0] holdData_A_2;  // sfix14_En3
  reg signed [13:0] A_2_offset;  // sfix14_En3
  wire signed [13:0] A_2;  // sfix14_En3
  reg signed [13:0] holdData_A_1;  // sfix14_En3
  reg signed [13:0] A_1_offset;  // sfix14_En3
  wire signed [13:0] A_1_1;  // sfix14_En3
  reg signed [13:0] holdData_A_0;  // sfix14_En3
  reg signed [13:0] A_0_offset;  // sfix14_En3
  wire signed [13:0] A_0_1;  // sfix14_En3
  ...
  wire notDone;
  wire signed [13:0] out_0;  // sfix14_E10
  wire signed [13:0] out_1;  // sfix14_E10
  wire out_0_enb;  // ufix1
  wire out_0_lastAddr;  // ufix1
  wire [7:0] out_0_addr_delay_1;  // ufix8
  reg signed [31:0] fp_out_0_0_expected;  // sfix32
  reg signed [13:0] out_0_0_expected;  // sfix14_E10
  reg signed [31:0] status_out_0_0_expected;  // sfix32
  reg signed [13:0] out_0_ref_hold;  // sfix14_E10
  wire signed [13:0] out_0_refTmp;  // sfix14_E10
  wire signed [13:0] out_0_ref;  // sfix14_E10
  reg  out_0_testFailure;  // ufix1
  reg signed [31:0] fp_out_0_1_expected;  // sfix32
  reg signed [13:0] out_0_1_expected;  // sfix14_E10
  reg signed [31:0] status_out_0_1_expected;  // sfix32
  reg signed [13:0] out_1_ref_hold;  // sfix14_E10
  wire signed [13:0] out_1_refTmp;  // sfix14_E10
  wire signed [13:0] out_1_ref;  // sfix14_E10
  reg  out_1_testFailure;  // ufix1
  wire testFailure;  // ufix1


  // Data source for A_0
  assign rawData_A_0 = 14'sb00000000000111;



  // Data source for A_1
  assign rawData_A_1 = 14'sb00000000000000;



  // Data source for A_3
  assign rawData_A_3 = 14'sb00000000000111;
  ...
  assign out_0_active = out_0_addr != 8'b10111100;
  ...
  assign #2 A_3_1 = A_3_offset;

  assign A_active = A_addr != 8'b10111100;
  ...
  always @(posedge clk or posedge reset)
    begin : A_process
      if (reset == 1'b1) begin
        ...
        if (A_enb) begin
          if (A_addr >= 8'b10111100) begin
            A_addr <= 8'b00000000;
          end
          else begin
            A_addr <= A_addr + 8'b00000001;
          end
        end
      end
    end
  ...
  assign #1 A_addr_delay_1 = A_addr;
  ...
  always @(A_addr_delay_1, phase_1, tb_enb)
    begin
      if (tb_enb == 0) begin
        rawData_A_2 <= 14'bx;
      end
  ...
  matrix_mul_fixedpt_fixpt_folded u_matrix_mul_fixedpt_fixpt (.clk(clk),
                                                       .reset(reset),
                                                       .clk_enable(enb_1_40_0),
                                                       .A_0(A_0_1),  // sfix14_En3
                                                       .A_1(A_1_1),  // sfix14_En3
                                                       .A_2(A_2),  // sfix14_En3
                                                       .A_3(A_3_1),  // sfix14_En3
                                                       .B_0(B_0),  // sfix14_E8
                                                       .B_1(B_1),  // sfix14_E8
                                                       .ce_out(ce_out),
                                                       .out_0(out_0),  // sfix14_E10
                                                       .out_1(out_1)  // sfix14_E10
                                                       );
  ...
  always @(posedge clk or posedge reset)
    begin : out_process
      if (reset == 1'b1) begin
        out_0_addr <= 8'b00000000;
      end
      else begin
        if (out_0_enb) begin
          if (out_0_addr >= 8'b10111100) begin
            out_0_addr <= 8'b00000000;
          end
          else begin
            out_0_addr <= out_0_addr + 8'b00000001;
          end
        end
      end
    end
  ...
  assign out_0_lastAddr = out_0_addr >= 8'b10111100;
