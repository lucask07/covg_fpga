...
if tf_type == 'elec_r_cc':
    if sys.platform == 'darwin':
        data_dir = '/Users/koer2434/Library/CloudStorage/OneDrive-UniversityofSt.Thomas/UST/research/covg/fpga_and_measurements/daq_v2/data/clamp/{}/'.format(capture_date)
...
if file_extra == '_vclamp': 
    ...
    r_total_guess = 5e3 + 3.32e3 # fit to square wave is not that sensitive to this. Returns same prediction for 10k guess

# Measured capacitance values on NB2 pg 119
# CC = 4.491 nF 
