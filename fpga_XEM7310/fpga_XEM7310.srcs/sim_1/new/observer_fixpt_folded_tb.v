// -------------------------------------------------------------
// 
// File Name: /home/delg/Documents/covg_fpga_project/covg_fpga/Matlab/control_system/observer/observer/codegen/observer/hdlsrc/observer_fixpt_tb.v
// Created: 2022-12-22 20:25:32
// 
...
//`define directory "/home/delg/Documents/covg_fpga_project/covg_fpga/Matlab/control_system/observer/observer/codegen/observer/hdlsrc/"
`define directory "C:/Users/delg5279/Documents/covg_fpga_project/covg_fpga/Matlab/control_system/observer/observer/codegen/observer/hdlsrc/"

module observer_fixpt_folded_tb;
  ...
  reg [31:0] rawData_B_1;  // ufix32_En50
  reg signed [31:0] status_B_1;  // sfix32
  reg [31:0] holdData_B_1;  // ufix32_En50
  reg [31:0] B_1_offset;  // ufix32_En50
  wire [31:0] B_1;  // ufix32_En50
  reg [6:0] y1_addr;  // ufix7
  reg signed [31:0] fp_B_0;  // sfix32
  reg [31:0] rawData_B_0;  // ufix32_En50
  reg signed [31:0] status_B_0;  // sfix32
  reg [31:0] holdData_B_0;  // ufix32_En50
  reg [31:0] B_0_offset;  // ufix32_En50
  wire [31:0] B_0;  // ufix32_En50
  wire [6:0] A_addr_delay;  // ufix7
  reg signed [31:0] fp_A_3;  // sfix32
  reg signed [31:0] rawData_A_3;  // sfix32_En24
  reg signed [31:0] status_A_3;  // sfix32
  reg signed [31:0] holdData_A_3;  // sfix32_En24
  reg signed [31:0] A_3_offset;  // sfix32_En24
  wire signed [31:0] A_3;  // sfix32_En24
  reg signed [31:0] fp_A_2;  // sfix32
  reg signed [31:0] rawData_A_2;  // sfix32_En24
  reg signed [31:0] status_A_2;  // sfix32
  reg signed [31:0] holdData_A_2;  // sfix32_En24
  reg signed [31:0] A_2_offset;  // sfix32_En24
  wire signed [31:0] A_2;  // sfix32_En24
  reg signed [31:0] fp_A_1;  // sfix32
  reg signed [31:0] rawData_A_1;  // sfix32_En24
  reg signed [31:0] status_A_1;  // sfix32
  reg signed [31:0] holdData_A_1;  // sfix32_En24
  reg signed [31:0] A_1_offset;  // sfix32_En24
  wire signed [31:0] A_1;  // sfix32_En24
  reg signed [31:0] fp_A_0;  // sfix32
  reg signed [31:0] rawData_A_0;  // sfix32_En24
  reg signed [31:0] status_A_0;  // sfix32
  reg signed [31:0] holdData_A_0;  // sfix32_En24
  reg signed [31:0] A_0_offset;  // sfix32_En24
  wire signed [31:0] A_0;  // sfix32_En24
  wire [6:0] L_addr_delay;  // ufix7
  reg signed [31:0] fp_L_3;  // sfix32
  reg signed [31:0] rawData_L_3;  // sfix32_En50
  reg signed [31:0] status_L_3;  // sfix32
  reg signed [31:0] holdData_L_3;  // sfix32_En50
  reg signed [31:0] L_3_offset;  // sfix32_En50
  wire signed [31:0] L_3;  // sfix32_En50
  reg signed [31:0] fp_L_2;  // sfix32
  reg signed [31:0] rawData_L_2;  // sfix32_En50
  reg signed [31:0] status_L_2;  // sfix32
  reg signed [31:0] holdData_L_2;  // sfix32_En50
  reg signed [31:0] L_2_offset;  // sfix32_En50
  wire signed [31:0] L_2;  // sfix32_En50
  reg signed [31:0] fp_L_1;  // sfix32
  reg signed [31:0] rawData_L_1;  // sfix32_En50
  reg signed [31:0] status_L_1;  // sfix32
  reg signed [31:0] holdData_L_1;  // sfix32_En50
  reg signed [31:0] L_1_offset;  // sfix32_En50
  wire signed [31:0] L_1;  // sfix32_En50
  reg signed [31:0] fp_L_0;  // sfix32
  reg signed [31:0] rawData_L_0;  // sfix32_En50
  reg signed [31:0] status_L_0;  // sfix32
  reg signed [31:0] holdData_L_0;  // sfix32_En50
  reg signed [31:0] L_0_offset;  // sfix32_En50
  wire signed [31:0] L_0;  // sfix32_En50
  wire [6:0] u_addr_delay_1;  // ufix7
  reg signed [31:0] fp_u;  // sfix32
  reg signed [15:0] rawData_u;  // int16
  reg signed [31:0] status_u;  // sfix32
  reg signed [15:0] holdData_u;  // int16
  reg signed [15:0] u_offset;  // int16
  wire signed [15:0] u;  // int16
  wire [6:0] y2_addr_delay_1;  // ufix7
  reg signed [31:0] fp_y2;  // sfix32
  reg signed [15:0] rawData_y2;  // int16
  reg signed [31:0] status_y2;  // sfix32
  reg signed [15:0] holdData_y2;  // int16
  reg signed [15:0] y2_offset;  // int16
  wire signed [15:0] y2;  // int16
  wire y1_active;  // ufix1
  wire y1_enb;  // ufix1
  wire [6:0] y1_addr_delay_1;  // ufix7
  reg signed [31:0] fp_y1;  // sfix32
  reg signed [15:0] rawData_y1;  // int16
  reg signed [31:0] status_y1;  // sfix32
  reg signed [15:0] holdData_y1;  // int16
  reg signed [15:0] y1_offset;  // int16
  wire signed [15:0] y1_1;  // int16
  ...
  wire notDone;
  wire clk_enable_1;
  wire signed [15:0] out_0;  // sfix16_En15
  wire signed [15:0] out_1;  // sfix16_En15
  wire out_0_enb;  // ufix1
  wire out_0_lastAddr;  // ufix1
  wire [6:0] out_0_addr_delay_1;  // ufix7
  reg signed [31:0] fp_out_0_0_expected;  // sfix32
  reg signed [15:0] out_0_0_expected;  // sfix16_En15
  reg signed [31:0] status_out_0_0_expected;  // sfix32
  reg signed [15:0] out_0_ref_hold;  // sfix16_En15
  wire signed [15:0] out_0_refTmp;  // sfix16_En15
  wire signed [15:0] out_0_ref;  // sfix16_En15
  reg  out_0_testFailure;  // ufix1
  reg signed [31:0] fp_out_0_1_expected;  // sfix32
  reg signed [15:0] out_0_1_expected;  // sfix16_En15
  reg signed [31:0] status_out_0_1_expected;  // sfix32
  reg signed [15:0] out_1_ref_hold;  // sfix16_En15
  wire signed [15:0] out_1_refTmp;  // sfix16_En15
  wire signed [15:0] out_1_ref;  // sfix16_En15
  ...
  assign out_0_active = out_0_addr != 7'b1100100;
  ...
  initial
    begin : L_3_fileread
      fp_L_3 = $fopen({`directory, "L_3.dat"}, "r");
  ...
  initial
    begin : L_2_fileread
      fp_L_2 = $fopen({`directory, "L_2.dat"}, "r");
  ...
  initial
    begin : L_1_fileread
      fp_L_1 = $fopen({`directory, "L_1.dat"}, "r");
  ...
  initial
    begin : L_0_fileread
      fp_L_0 = $fopen({`directory, "L_0.dat"}, "r");
  ...
  initial
    begin : y2_fileread
      fp_y2 = $fopen({`directory, "y2.dat"}, "r");
  ...
  assign y1_active = y1_addr != 7'b1100100;
  ...
  initial
    begin : y1_fileread
      fp_y1 = $fopen({`directory, "y1.dat"}, "r");
  ...
  observer_fixpt_folded u_observer_fixpt_folded (.clk(clk),
                                   .reset(reset),
                                   ...
                                   .B_1(B_1),  // ufix32_En50
                                   .ce_out(ce_out),
                                   .out_0(out_0),  // sfix16_En15
                                   .out_1(out_1)  // sfix16_En15
                                   );
  ...
  always @(posedge clk or posedge reset)
    begin : out_process
      if (reset == 1'b1) begin
        ...
        if (out_0_enb) begin
          if (out_0_addr >= 7'b1100100) begin
            out_0_addr <= 7'b0000000;
          end
          else begin
  ...
  assign out_0_lastAddr = out_0_addr >= 7'b1100100;
  ...
  always @(posedge clk or posedge reset)
    begin : out_0_checker
      if (reset == 1'b1) begin
        ...
        else if (ce_out == 1'b1 && out_0 == out_0_ref) begin
            $display("Correct in out_0 at time %t : Expected '%h' Actual '%h'", $time, out_0_ref, out_0);
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : out_1_checker
      if (reset == 1'b1) begin
        ...
        else if (ce_out == 1'b1 && out_1 == out_1_ref) begin
            $display("Correct in out_1 at time %t : Expected '%h' Actual '%h'", $time, out_1_ref, out_1);
        end
      end
    end
