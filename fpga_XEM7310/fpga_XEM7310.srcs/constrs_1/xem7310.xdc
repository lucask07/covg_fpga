...
#set_property SLEW FAST [get_ports {pushreset}]  - not valid for input port
...
set_property DRIVE 8 [get_ports {d_sdi[3]}]
...
set_property DRIVE 8 [get_ports {d_sdi[1]}]
...
set_property DRIVE 8 [get_ports {d_sclk[1]}]
