...
set genomeRtd $env(RT_TMP)/125C0DD5F50.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_level_module__GCB4}]"
...
set genomeName [subst -nocommands -novariables {top_level_module__GCB4}]
