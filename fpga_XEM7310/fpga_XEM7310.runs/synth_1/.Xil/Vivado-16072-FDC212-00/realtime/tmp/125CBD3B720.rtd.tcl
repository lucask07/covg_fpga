...
set genomeRtd $env(RT_TMP)/125CBD3B720.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_level_module__GCB3}]"
...
set genomeName [subst -nocommands -novariables {top_level_module__GCB3}]
