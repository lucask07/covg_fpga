...
#
# Generated by export_simulation on Wed Oct 06 13:20:02 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './fifo_AD796x.sh' script.

./fifo_AD796x.sh -reset_run
...
./fifo_AD796x.sh -noclean_files

For more information on the script, please type './fifo_AD796x.sh -help'.
